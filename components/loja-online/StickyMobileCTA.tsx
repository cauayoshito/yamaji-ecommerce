...
export default function StickyMobileCTA() {
  return (
    <div
      className="fixed inset-x-0 bottom-0 z-40 border-t border-white/[0.08] bg-[#08090B]/90 px-4 py-3 backdrop-blur-xl md:hidden"
    ...
    >
      <a
        ...
        data-cta="primary"
        data-label="loja-sticky-mobile"
        className="flex w-full items-center justify-center gap-2 rounded-lg bg-accent px-5 py-3.5 text-[14px] font-semibold text-black shadow-[0_1px_0_rgba(255,255,255,0.12)_inset]"
      >
        <svg
          viewBox="0 0 24 24"
          className="h-4 w-4"
