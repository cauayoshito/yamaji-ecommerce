    ...
    <section className="relative overflow-hidden bg-bg">
      ...
      <div className="relative mx-auto max-w-container px-6 py-20 text-center md:py-24">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-[17px] leading-relaxed text-muted">
          Atendimento, qualificação, <span className="text-fg">follow-up</span>{" "}
          e relatórios automáticos, integrados ao seu site e anúncios.
        </p>

        {/* CTAs */}
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a
            href="https://wa.me/5571992258349?text=Quero%20automatizar%20meu%20comercial%20com%20IA%20na%20Yamaji%20Studio"
            target="_blank"
            className="btn btn-primary"
            aria-label="Falar com a Yamaji sobre automação com IA"
          >
            Falar no WhatsApp
          </a>
          <a
            ...
            aria-label="Ver automações disponíveis"
          >
            Ver blueprints
          </a>
        </div>
