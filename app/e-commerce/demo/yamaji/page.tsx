...
export const metadata: Metadata = {
  title: "Demonstração Yamaji E-commerce | Fluxo completo",
  description:
    "Explore a demonstração autoral da Yamaji E-commerce, da vitrine ao checkout, pós-compra e painel de gestão.",
  alternates: { canonical: "/e-commerce/demo/yamaji" },
};

const whatsappLink = createWhatsAppLink(
  "Olá! Vi a demonstração Yamaji E-commerce e quero entender como esse fluxo funcionaria no meu negócio."
);

export default function YamajiEcommerceDemoPage() {
  return (
